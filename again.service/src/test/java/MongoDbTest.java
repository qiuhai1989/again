import com.haqiu.core.entity.Item;
import com.haqiu.core.entity.Order;
import com.haqiu.core.mongo.OrderRepository;
...
public class MongoDbTest {
    ...
    public void testFind(){
        String orderId = "1";
        Order order = mongoOperations.findById(orderId,Order.class);
